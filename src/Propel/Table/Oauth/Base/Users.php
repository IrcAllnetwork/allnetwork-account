...
use Propel\Table\Oauth\UsersQuery as ChildUsersQuery;
use Propel\Table\Oauth\Map\UsersTableMap;

/**
 * Base class that represents a row from the 'oauth_users' table.
 *
 *
 *
...
abstract class Users implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Table\\Oauth\\Map\\UsersTableMap';
    ...
    /**
     * Initializes internal state of Propel\Table\Oauth\Base\Users object.
     */
     ...
     * @return $this|\Propel\Table\Oauth\Users The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Table\\Oauth\\Users'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO oauth_users (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Table\Oauth\Users
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\Table\Oauth\Users The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Table\Oauth\Users (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Table\Oauth\Users Clone of current object.
     * @throws PropelException
     */
